...
tf.compat.v1.flags.DEFINE_string('training_data_path', '/data/ocr/icdar2015/',
                           'training dataset to use')
tf.compat.v1.flags.DEFINE_integer('max_image_large_side', 1280,
                            'max image size of training')
tf.compat.v1.flags.DEFINE_integer('max_text_size', 800,
                            'if the text in the input image is bigger than this, then we resize'
                            'the image according to this')
tf.compat.v1.flags.DEFINE_integer('min_text_size', 10,
                            'if the text size is smaller than this, we ignore it during training')
tf.compat.v1.flags.DEFINE_float('min_crop_side_ratio', 0.1,
                          'when doing random crop from input image, the'
                          'min length of min(H, W')
tf.compat.v1.flags.DEFINE_string('geometry', 'RBOX',
